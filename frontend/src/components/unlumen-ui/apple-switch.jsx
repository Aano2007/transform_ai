...
const switchTones = {
  neutral: {
    off: 'color-mix(in srgb, var(--clay-primary-muted, #7c858e) 50%, transparent)',
    on: '#495057',
    thumb: '#ffffff',
    glow: 'color-mix(in srgb, #495057 32%, transparent)',
  },
  accent: {
    off: 'color-mix(in srgb, var(--clay-primary-muted, #7c858e) 50%, transparent)',
    on: '#212529',
    thumb: '#ffffff',
    glow: 'color-mix(in srgb, #212529 42%, transparent)',
  },
  ios: {
    off: 'rgba(120, 120, 128, 0.2)',
    on: '#34c759',
    thumb: '#ffffff',
...
const AppleSwitch = forwardRef(
  (
    ...
    const metrics = switchSizes[size] || switchSizes.md;
    const colors = switchTones[tone] || switchTones.neutral;
    ...
    const switchEl = (
      <button
        ...
        className={cn(
          ...
          'border border-white/40 shadow-inner backdrop-blur-md',
        ...
        style={{
          ...
          touchAction: 'pan-y',
          boxShadow: 'inset 2px 2px 4px rgba(73, 80, 87, 0.15), inset -2px -2px 4px rgba(255, 255, 255, 0.8)',
          ...style,
        }}
        {...props}
      >
        ...
        <motion.span
          ...
          style={{
            ...
            boxShadow:
              '0 3px 10px rgba(73, 80, 87, 0.28), 0 1px 2px rgba(0,0,0,0.12), inset 0 1px 1px rgba(255,255,255,0.95), inset 0 -1px 1px rgba(0,0,0,0.06)',
          }}
        />
      </button>
    );
