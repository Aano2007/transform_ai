  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        item.isActive && "magnetic-dock-item-active bg-neutral-200/50 dark:bg-white/10"
      )}
      style={{
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="magnetic-dock-icon w-[60%] h-[60%] flex items-center justify-center text-neutral-700 dark:text-white"
        >
          {item.icon}
        </div>
        ...
        {/* Shine effect */}
        <motion.div
          className="magnetic-dock-shine absolute inset-0 pointer-events-none"
          style={{
            background:
...
export function MagneticDock({
  ...
  const variantStyles = {
    ...
    transparent: "magnetic-dock-transparent bg-transparent border-0",
  };
